...
# ssh_pubkey_file = "" on your terraform.tfvars, this will just use the
# already existing and uploaded key. Even if you already uplaoded the key,
# if you set the ssh_pubkey_file variable to the same key, this will just
...
# set ssh_pubkey_file to your pubkey file path, and it will be uplaoded
...
# just set ssh_pubkey_data = "" and ssh_pubkey_file = "" in your
