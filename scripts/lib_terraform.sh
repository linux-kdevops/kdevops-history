...
import_generic_terraform_vars()
{
	...
	SSHCONFIGFILE=$CONFIG_TERRAFORM_SSH_CONFIG
	SSHCONFIGUPDATE="$(kconfig_y_to_true_false $CONFIG_TERRAFORM_SSH_CONFIG_UPDATE)"
	SSHCONFIGSTRICT="$(kconfig_y_to_true_false $CONFIG_TERRAFORM_SSH_CONFIG_UPDATE_STRICT)"
	SSHCONFIGBACKUP="$(kconfig_y_to_true_false $CONFIG_TERRAFORM_SSH_CONFIG_UPDATE_BACKUP)"
}
