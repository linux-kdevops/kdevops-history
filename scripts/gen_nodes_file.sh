...
LIBVIRTURI=$CONFIG_LIBVIRT_URI
LIBVIRTSYSTEMURI=$CONFIG_LIBVIRT_SYSTEM_URI
LIBVIRTSESSION=$CONFIG_LIBVIRT_SESSION
LIBVIRTSESSIONSOCKET=$CONFIG_LIBVIRT_SESSION_SOCKET
LIBVIRTSESSIONMANAGEMENTNETWORKDEVICE=$CONFIG_LIBVIRT_SESSION_MANAGEMENT_NETWORK_DEVICE
LIBVIRTSESSIONPUBLICNETWORKDEV=$CONFIG_LIBVIRT_SESSION_PUBLIC_NETWORK_DEV
VAGRANTVCPUSCOUNT=$CONFIG_VAGRANT_VCPUS_COUNT
VAGRANTMEMMB=$CONFIG_VAGRANT_MEM_MB
...
if [[ "$LIBVIRTSESSION" == "y" ]]; then
	LIBVIRTSESSION="true"
else
	LIBVIRTSESSION="false"
fi
