...
VAGRANTENABLEZNS=$CONFIG_VAGRANT_ENABLE_ZNS
...
KDEVOPSSTORAGEPOOLPATH=$CONFIG_KDEVOPS_STORAGE_POOL_PATH

if [[ "$VAGRANTENABLEZNS" == "y" ]]; then
	VAGRANTENABLEZNS="true"
else
	VAGRANTENABLEZNS="false"
fi
